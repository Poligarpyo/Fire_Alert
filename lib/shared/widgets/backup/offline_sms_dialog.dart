...
//       // 2️⃣ Combine message + coordinates
//       final message =
//           "${_messageController.text}\nLocation: ${position.latitude}, ${position.longitude}";

//       // 3️⃣ Encode message for URI
//       final encodedMessage = Uri.encodeComponent(message);

//       // 4️⃣ Create SMS URI
//       final Uri smsUri = Uri.parse('sms:9051901129?body=$encodedMessage');

//       // 5️⃣ Launch default SMS app
//       if (await canLaunchUrl(smsUri)) {
//         await launchUrl(smsUri);
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//             content: Text('SMS app opened. Please tap Send to report.'),
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//             content: Text('No SMS app found on this device.'),
//             backgroundColor: Colors.red,
//           ),
//         );
//       }
//     } catch (e) {
//       // Catch all errors (location fail, launch fail, etc.)
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('Failed to prepare SMS: $e'),
//           backgroundColor: Colors.red,
//         ),
//       );
//     }
