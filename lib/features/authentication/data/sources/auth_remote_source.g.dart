...
const authRemoteSourceProvider = AuthRemoteSourceProvider._();
...
final class AuthRemoteSourceProvider
  ...
  const AuthRemoteSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
...
String _$authRemoteSourceHash() => r'66a2900197ded5fa27f004222e09530db146c7d4';
